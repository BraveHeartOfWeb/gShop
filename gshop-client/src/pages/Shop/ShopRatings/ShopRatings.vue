  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <div class="switch" :class="{on: onlyShowText === true}" >
...
export default {
  ...
  computed: {
    ...
    filterRatings () {
      ...
      /*
      条件一：
        需要用到selectType和rateType
        selectType === 2 ||
        selectType ===rateType
      条件二：
        需要用到onlyShowText和text
        onlyShowText如果为false则不要求text有值
          onlyShowText === false  即为！onlyShowText
        onlyShowText如果为true，则要判断必须要求text.length>0
          onlyShowText === true && text.length > 0, 即为text.length > 0
        这两种情况有一种即可,所以是或的关系
       */
    }
  },
